...
export default function Filtros({ selectedOptions, setSelectedOptions }: FiltrosProps) {
                  ...
                  <div className="p-2 bg-white rounded">
                    {filterOptions[filter].map((option) => (
                      ...
                      >
                        ...
                        <span
                          className="
                            w-5 h-5 min-w-[20px] min-h-[20px] flex items-center justify-center rounded
