...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center text-center z-20 max-w-[100%]">
        <h1
          className="text-6xl md:text-[100px] text-white mb-6 leading-tight"
        ...
        <p className="text-lg md:text-2xl font-dosis text-white mb-8 leading-relaxed max-w-full">
