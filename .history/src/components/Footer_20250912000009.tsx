          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div>
              ...
              <ul className="space-y-1 sm:space-y-2 text-center">
                ...
                <li>
                  <Link href="#" className="text-[#ffffff] font-dosis                   className="text-[#ffffff] font-dosis text-sm sm:text-base hover:text-[#ffcc00] transition-colors"
 hover:text-[#ffcc00] transition-colors">
