         ...
         <div className="w-64 flex flex-col gap-4 bg-[#f9f9f9] p-4 rounded-lg shadow-md">
            ...
            {(Object.keys(filterOptions) as (keyof typeof filterOptions)[]).map((filter) => (
              <div key={filter} className="flex flex-col">
                <Button
                  variant="outline"
                  className={`w-full bg-[#0c3729] text-md font-dosis font-semibold text-white border-[#0c3729] rounded shadow-md ${
            ...
            <Button
              variant="outline"
              className="bg-[#8f3332] text-md font-dosis font-bold text-white border-[#8f3332] rounded shadow-md"
