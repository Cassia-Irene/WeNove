          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="group flex gap-3 sm:gap-4 justify-center">
                ...
                <div className="w-9 h-9 sm:w-10 sm:h-10 bg-[transparent] border-2 border-[#ffcc00] bg-opacity-20 rounded-full flex items-center justify-center transition-colors duration-300 hover:bg-[#ffcc00]">
                  <Image  
