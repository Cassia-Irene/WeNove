...
export default function Filtros() {
  ...
  return (
    <>
      ...
      <div className="flex justify-center lg:hidden xl:hidden mb-4">
        <Button
          onClick={() => setIsMobileFiltersOpen(true)}
          className="bg-[#0c3729] text-white flex items-center gap-2"
        >
          <Sliders className="w-5 h-5" /> Filtros
        </Button>
      </div>
      ...
      {/* Filtros desktop */}
      <div className="hidden :block w-64">
