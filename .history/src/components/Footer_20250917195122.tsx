        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="mb-4 sm:mb-6 justify-center mx-auto w-32 sm:w-auto">
                <Image 
                src="/Logo-footer.svg"
                alt="Wenove Logo"
                fill
              ...
              <div className="group flex gap-3 sm:gap-4 justify-center">
                ...
                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[transparent] border-2 border-[#ffcc00] bg-opacity-20 rounded-full flex items-center justify-center transition-colors duration-300 hover:bg-[#ffcc00]">
                  <Image  src="/footer-zap.svg" alt="Facebook" fill className="w-4 h-4 sm:w-6 sm:h-6" />
                </div>

                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[transparent] border-2 border-[#ffcc00] bg-opacity-20 rounded-full flex items-center justify-center transition-colors duration-300 hover:bg-[#ffcc00]">
                  <Image  src="/footer-email.svg" alt="Email" fill className="w-4 h-4 sm:w-5 sm:h-5" />
                </div>

                <div className="w-8 h-8 sm:w-10 sm:h-10 bg-[transparent] border-2 border-[#ffcc00] bg-opacity-20 rounded-full flex items-center justify-center transition-colors duration-300 hover:bg-[#ffcc00]">
                  <Image  src="/footer-instagram.svg" alt="Instagram" fill className="w-5 h-5 sm:w-7 sm:h-7" />
                </div>
            ...
            <div>
              ...
              <h4 className="text-[#ffffff] font-dosis text-base sm:text-lg font-bold mb-2 text-center">Para você</h4>
              
              <div className="w-[200px] h-[1px] bg-[#EFE8DB] mx-auto mb-2w-[150px] sm:w-[200px] h-[1px] bg-[#EFE8DB] mx-auto mb-2" />
