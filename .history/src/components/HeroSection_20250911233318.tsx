...
export default function HeroSection() {
  ...
  return (
    <section className="relative w-full h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute z-20 px-6 sm:px-6 lg:px sm max-w-8xl text-center -translate-y-10">
        <h1
        ...
        <p className="text-lg md:text-3xl font-dosis font-medium text-white mb-8">
