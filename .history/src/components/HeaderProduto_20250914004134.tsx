...
interface HeaderProdutoProps {
  logoSrc?: string;        // caminho da logo
  cartColor?: string;      // cor do ícone do carrinho
}
...
export default function HeaderProduto({ logoSrc, cartColor }: HeaderProdutoProps) {
  return (
      ...
      {/* Header */}
      <header className="absolute inset-x-0 top-0 z-30 h-16 sm:h-20 lg:h-24 flex items-center justify-between px-4 sm:px-6">
