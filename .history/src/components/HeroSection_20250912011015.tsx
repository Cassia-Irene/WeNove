    ...
    <section className="relative w-full h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute z-20 px-6 sm:px-6 lg:px-8 max-w-8xl text-center -translate-y-10">
        ...
        <div className="flex flex-col sm:flex-row gap-6 sm:gap-6 lg:gap-10 justify-center items-center">
          ...
          <Button className="bg-[#88a51d] text-white hover:bg-[#708943] px-6 sm:px-7 lg:px-9 py-4 sm:py-5 lg:py-6 font-dosis text-base sm:text-lg font-medium w-full sm:w-auto">
            Faça seu Cadastro
          </Button>
        </div>
      </div>
