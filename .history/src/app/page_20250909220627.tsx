          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-center">
                ...
                <li>
                  <a href="#" className="text-[#ffffff] text-m hover:text-[#ffcc00] transition-colors">
                    Sobre nós
                  </a>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="space-y-2 text-center">
                <li>
                  <a href="#" className="text-[#ffffff] font-dosis text-sm hover:text-[#ffcc00] transition-colors">
