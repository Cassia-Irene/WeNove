...
export default function WenoveLanding() {
  ...
  <header className="absolute top-0 left-0 w-full h-24 z-10 flex items-center justify-between px-6">
    ...
    <div>
      ...
      {/* Section de Serviços */}
      <section className="py-16 px-6 relative z-20 mt-[-195px]">
  {/* Imagem de fundo menor e com cantos arredondados */}
  <div
    className="mx-auto mb-12 overflow-hidden rounded-[20px]"
    style={{
      maxWidth: '1200px', // largura máxima desejada
