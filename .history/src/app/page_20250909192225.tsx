        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-[510px]">
              <h2 
                className="text-6xl text-[#ffcc00] text-justify mb-6 leading-tight"
                style={{ fontFamily: "Futura, sans-serif" }}
                >
                  Uma plataforma que
                  <br />
              ...
              <p className="text-[#0C3729] font-dosis font-medium text-[28px] text-justify leading-relaxed"
              style={{letterSpacing: '-0.0554em'}}
              >
            ...
            <div className="flex justify-center relative">
              ...
              className="w-full h-full max-w-md relative -top-6" 
              />
            </div>
