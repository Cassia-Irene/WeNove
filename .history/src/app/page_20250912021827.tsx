  ...
  return (
    ...
    <div className="min-h-screen relative bg-transparent">
      ...
      <header className="absolute top-0 left-0 w-full h-16 sm:h-20 lg:h-24 z-10 flex items-center justify-between px-4 sm:px-6">
        ...
        <section
          className="relative py-8 sm:py-12 lg:py-16 px-4 sm:px-6 z-20 mt-[-100px] sm:mt-[-120px] lg:mt-[-150px] rounded-[20px] overflow-hidden max-w-[95%] md:max-w-[75%] lg:max-w-[95%] xl:max-w-[65%]"
          style={{
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
              ...
              <Card className="group bg-[transparent] border-2 sm:border-4 border-[#8f3332] rounded-lg transition-colors duration-300 hover:bg-[#8F3332] hover:border-[#8F3332]">
                ...
                <CardContent className="p-4 sm:p-6 text-center">
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-3xl text-[#8f3332] mb-2 sm:mb-3 transition-colors duration-300 group-hover:text-white"
                  style={{ fontFamily: "Futura, sans-serif" }}
                  >REAPROVEITAMENTO</h3>
