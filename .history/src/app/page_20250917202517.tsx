  ...
  return (
    ...
    <div className="min-h-screen relative bg-transparent">
      ...
      <header className="absolute top-0 left-0 w-full h-16 sm:h-20 lg:h-24 z-10 flex items-center justify-between px-4 sm:px-6">
        ...
        {/* Logo */}
          ...
          src="/Logo-landing.svg"
            width={Logo-landing.svg.width}
            height={Logolanding.height}
          alt="Wenove Logo"
          className="relative top-6 sm:top-6 lg:top-[30px] left-4 sm:left-6 lg:left-[30px] w-34 sm:w-34 lg:w-auto"
          />
        ...
        <div className="hidden sm:flex absolute top-4 sm:top-6 lg:top-[30px] left-1/2 -translate-x-1/2 w-[400px] lg:w-[500px] h-[40px] lg:h-[50px] flex items-center justify-center">
          ...
          <nav className="relative flex items-center gap-6 lg:gap-10 text-white text-sm lg:text-base">
            ...
            <Link href="/sobre-nos#contato" className="hover:text-[#ffcc00] transition-colors">Contato</Link>
          </nav>
        </div>
        ...
        <section
          className="relative py-8 sm:py-12 lg:py-16 px-4 sm:px-6 z-20 mt-[-100px] sm:mt-[-120px] lg:mt-[-150px] xl:mt-[-100px] rounded-[20px] overflow-hidden max-w-[90%] md:max-w-[85%] lg:max-w-[95%] xl:max-w-[70%]"
          style={{
        ...
        >
          <div className="relative z-10 max-w-6xl mx-auto">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl text-[#8f3332] text-center mb-8 sm:mb-10 lg:mb-12 text-balance"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-4">
              ...
              <Card className=" group bg-[transparent] border-2 sm:border-4 border-[#8f3332] rounded-lg transition-colors duration-300 hover:bg-[#8F3332] hover:border-[#8F3332]">
                ...
                <CardContent className="p-1 sm:p-6 text-center">
                  ...
                  <h3 className="text-lg sm:text-xl text-[#8f3332] mb-2 sm:mb-3 transition-colors duration-300 group-hover:text-white"
                  style={{ fontFamily: "Futura, sans-serif" }}
                  >COLETA</h3>
      ...
      {/* Section sobre a Plataforma */}
        ...
        <section className="py-8 sm:py-20 lg:py-25 lg:px-15 xl:py-30 px-4 mb-8 sm:px-6 bg-[#ffffff]">
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
              ...
              <div className="order-2 lg:order-1">
                <h2 
                  className="text-4xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-[60px] text-[#ffcc00] text-center lg:text-left mb-4 sm:mb-6 leading-tight text-balance"
                  style={{ fontFamily: "Futura, sans-serif" }}
                  >
                    Uma plataforma que
                    <br />
              ...
              <div className="flex justify-center relative order-1 lg:order-2">
                <div className="w-[80%] lg:w-[90%] max-w-md lg:max-w-full relative lg:-top-10 h-[300px] lg:h-[400px]">
                  <Image  
                    src="/img-sobre_plataforma.svg" 
                    alt="Ilustração sobre a plataforma"
                    fill
      ...
      {/* Section Como Funciona */}
        <section id="funcionamento" className="relative py-8 sm:py-12 lg:py-16 px-4 sm:px-6 min-h-[400px] sm:h-[450px] lg:h-[500px] max-w-[90%] md:max-w-[85%] lg:max-w-[95%] xl:max-w-[70%] bg-[#0c3729] rounded-[20px] overflow-hidden mx-auto mb-20 sm:mb-30 lg:mb-40"
        style={{boxShadow: '-4px -4px 4px 0 rgba(0, 0, 0, 0.25), 4px 4px 4px 0 rgba(0, 0, 0, 0.25)'}}
        >
          
          <div className="max-w-4xl mx-auto text-center lg:-mt-8 xl-mt-10">
            
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-[#ffffff] mb-2 sm:mb-3 text-balance"
            style={{ fontFamily: "Futura, sans-serif" }}
            >Como funciona a Wenove</h2>
            
            <p className="text-[#ffcc00] font-dosis font-dosis font-semibold text-base sm:text-lg md:text-xl lg:text-2xl mb-6 sm:mb-8 lg:mb-10 text-pretty">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
              ...
              <Card className="group bg-transparent border-2 sm:border-4 border-[#ffcc00] rounded-lg transition-colors duration-300 hover:bg-[#ffcc00]">
                ...
                <CardContent className="p-4 sm:p-6 text-center">
                  ...
                  <h3 className="text-lg sm:text-xl lg:text-2xl text-[#ffffff] mb-2 sm:mb-3"
                  style={{ fontFamily: "Futura, sans-serif" }}
                  >EXPLORE</h3>
              ...
              <Card className="group bg-transparent border-2 sm:border-4 border-[#ffcc00] rounded-lg transition-colors duration-300 hover:bg-[#ffcc00] md:col-span-2 lg:col-span-1">
                ...
                <CardContent className="p-4 sm:p-6 text-center">
                  <div className="w-12 h-12 sm:w-16 sm:h-16 bg-transparent rounded-lg flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-12 sm:py-16 lg:py-25 px-4 sm:px-6 bg-[#efe8db] mb-20 sm:mb-30 lg:mb-40"
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <h3 className="text-lg sm:text-xl lg:text-2xl text-[#88a51d] mb-2 sm:mb-3"
              style={{ fontFamily: "Futura, sans-serif" }}
