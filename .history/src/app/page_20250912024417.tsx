...
export default function WenoveLanding() {
  ...
  return (
    ...
    <div className="min-h-screen relative bg-transparent">
      ...
      <section className="py-16 sm:py-20 lg:py-35 px-4 sm:px-4 bg-[#ffffff]">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-12">
            ...
            <div className="">
              <h2 
                className="text-3xl sm:text-6xl md:text-5xl lg:text-[55px] text-[#ffcc00] text-center lg:text-left mb-4 sm:mb-6 leading-tight text-balance"
                style={{ fontFamily: "Futura, sans-serif" }}
                >
                  Uma plataforma que
                  <br />
