      ...
      <section className="py-40 px-6 bg-[#ffffff]">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-5xl text-[#ffcc00] text-justify mb-6 leading-tight max-w-[550px]"
              style={{ fontFamily: "Futura, sans-serif" }}>
                Uma plataforma que
                <br />
            ...
            <div className="flex justify-center">
              <img src="/img-sobre_plataforma.svg" alt="Platform illustration" className="w-full max-w-md -mt-6" />
            </div>
          </div>
        </div>
      </section>
