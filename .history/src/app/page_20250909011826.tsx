    ...
    <div className="min-h-screen">
      ...
      <header className="absolute top-0 left-0 w-full h-24 bg-transparent z-10">
        ...
        <div className="relative flex-1 flex justify-center items-center">
          ...
          <div className="absolute w-[90%] max-w-[500px] h-12 rounded-[30px] bg-[#CDBBA7]/30 shadow-[0_4px_4px_rgba(0,0,0,0.25)] top-0" />"></div>
        </div>

        <nav className="hidden md:flex absolute left-1/2 mt-[55px] -translate-x-1/2 -translate-y-1/2 items-center gap-10 font-Futura">
        ...
        <div className="absolute top-[30px] right-[30px]">
          ...
          before:inset-0 
          before:shadow-inner 
          before:shadow-[0_4px_4px_rgba(0,0,0,0.25)] 
          before:rounded-full 
          rounded-full
