    ...
    <div>
      ...
      <section className="py-16 px-6 bg-[#efe8db] mb-40">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-[500px]">
            <div className="text-center">
              ...
              <p className="text-[#88A51D] text-center font-dosis font-semibold text-m leading-relaxed">Moda que faz sentido para você e para o planeta.</p>
            </div>
