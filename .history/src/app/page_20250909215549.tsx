          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="flex gap-4 justify-center">
                <div className="w-10 h-10 bg-[transparent] border-2 border-[#ffcc00] bg-opacity-20 rounded-full flex items-center justify-center">
                  <img src="/footer-zap.svg" alt="Facebook" className="" />
                </div>

                <div className="w-10 h-8 bg-[transparent] border-2 border-[#ffcc00] bg-opacity-20 rounded-full flex items-center justify-center">
                  <img src="/footer-email.svg" alt="Facebook" className="" />
                </div>

                <div className="w-8 h-8 bg-[transparent] border-2 border-[#ffcc00] bg-opacity-20 rounded-full flex items-center justify-center">
                  <img src="/footer-instagram.svg" alt="Facebook" className="" />
                </div>
              </div>
            </div>
