...
export default function WenoveLanding() {
  ...
  <header className="absolute top-0 left-0 w-full h-24 z-10 flex items-center justify-between px-6">
    ...
    <div>
      ...
      <section className="py-40 px-6 bg-[#ffffff]">
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-5xl text-[#ffcc00] text-justify mb-6 leading-tight"
              style={{ fontFamily: "Futura, sans-serif" }}>
                Uma plataforma que
                <br />
                conecta e transforma
              </h2>
              <p className="text-[#0C3729] font-dosis font-medium text-lg text-justify leading-relaxed max-w-[550px]">
                Somos uma marketplace que aproxima consumidores, marcas e empreendedorresponsáveis, criando oportunidades para dar uma nova vida às peças. Mais do que moda, promovemos consumo inteligente e impacto positivo.
              </p>
            </div>
            <div className="flex justify-center">
              <img src="/img-sobre_plataforma.svg" alt="Platform illustration" className="w-full max-w-md" />
            </div>
          </div>
        </div>
      </section>
