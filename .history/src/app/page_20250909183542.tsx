      ...
      >
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <Card className=" group bg-[transparent] border-4 border-[#8f3332] rounded-lg transition-colors duration-300 hover:bg-[#8F3332] hover:border-[#8F3332]">
              <CardContent className="p-6 text-center">
                <div className="w-16 h-16 bg-[transparent] rounded-lg flex items-center justify-center mx-auto mb-4">
                  <Package className="w-16 h-16 text-[#8F3332]" />
                </div>
            ...
            <Card className="bg-[transparent] border-4 border-[#8f3332] rounded-lg">
              <CardContent className="p-6 text-center">
                <div className="w-16 h-16 bg-[transparent] rounded-lg flex items-center justify-center mx-auto mb-4">
                  <Scissors className="w-16 h-16 text-[#FFFFFF] group-hover:text-[#FFFFFF] transition-colors duration-300" />
                </div>
                <h3 className="text-2xl text-[#8f3332] mb-3"
                style={{ fontFamily: "Futura, sans-serif" }}
                >TRIAGEM</h3>
                <p className="text-[#993F3C] font-dosis text-m leading-relaxed">
            ...
            <Card className="bg-[transparent] border-4 border-[#8f3332] rounded-lg">
              <CardContent className="p-6 text-center">
                <div className="w-16 h-16 bg-[transparent] rounded-lg flex items-center justify-center mx-auto mb-4">
                  <RefreshCw className="w-16 h-16 text-[#8f3332]" />
                </div>
                <h3 className="text-2xl text-[#8f3332] mb-3"
                style={{ fontFamily: "Futura, sans-serif" }}
                >REAPROVEITAMENTO</h3>
