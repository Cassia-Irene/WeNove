  ...
  return (
    ...
    <div className="min-h-screen relative bg-transparent">
      ...
      <header className="absolute top-0 left-0 w-full h-16 sm:h-20 lg:h-24 z-10 flex items-center justify-between px-4 sm:px-6">
        ...
        <section
          className="relative py-8 sm:py-12 lg:py-16 px-4 sm:px-6 z-20 mt-[-100px] sm:mt-[-120px] lg:mt-[-150px] rounded-[20px] overflow-hidden max-w-[90%] md:max-w-[85%] lg:max-w-[95%] xl:max-w-[70%]"
          style={{
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
              ...
              <div className="order-2 lg:order-1">
                ...
                <p className="text-[#0C3729] font-dosis font-medium text-lg sm:text-xl md:text-2xl lg:text-2xl xl:text-[22px] text-center lg:text-justify leading-relaxed max-w-[320px] sm:max-w-none lg:max-w-[400px] xl:max-w-[500px] mx-auto lg:mx-0 tracking-tighter sm:tracking-normal lg xl:tracking-wide"
                >
      ...
      {/* Section Como Funciona */}
        <section className="relative py-8 sm:py-12 lg:py-16 px-4 sm:px-6 min-h-[400px] sm:h-[450px] lg:h-[500px] max-w-[90%] md:max-w-[85%] lg:max-w-[95%] xl:max-w-[70%] bg-[#0c3729] rounded-[20px] overflow-hidden mx-auto mb-20 sm:mb-30 lg:mb-40"
