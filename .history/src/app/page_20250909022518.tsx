      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-10 justify-center mb-12">
            <Button className="bg-[#8f3332] text-[#ffffff] hover:bg-[#8b3130] px-8 py-6 font-dosis text-lg font-medium">
              Como Funciona
            </Button>
            <Button className="bg-[#88a51d] text-[#ffffff] hover:bg-[#708943] px-8 py-6 font-dosis text-lg font-semibold">
              Faça seu Cadastro
            </Button>
          </div>
