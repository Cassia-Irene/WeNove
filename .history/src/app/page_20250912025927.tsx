...
export default function WenoveLanding() {
  ...
  return (
    ...
    <div className="min-h-screen relative bg-transparent">
      ...
      <section className="py-10 sm:py-20 lg:py-25 lg:px-15 px-4 sm:px-6 bg-[#ffffff]">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8">
            ...
            <div className="order-2 lg:order-1">
              ...
              <p className="text-[#0C3729] font-dosis font-medium text-lg sm:text-xl md:text-2xl lg:text-[22px] text-center lg:text-justify leading-relaxed max-w-[500px] mx-auto lg:mx-0"
              style={{letterSpacing: '-0.010em'}}
              >
