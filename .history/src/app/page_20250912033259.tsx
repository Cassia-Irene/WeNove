  ...
  return (
    ...
    <div className="min-h-screen relative bg-transparent">
      ...
      {/* Section Como Funciona */}
        <section className="relative py-8 sm:py-12 lg:py-16 px-4 sm:px-6 min-h-[400px] sm:h-[450px] lg:h-[500px] max-w-[95%] lg:max-w-[90%] bg-[#0c3729] rounded-[20px] overflow-hidden mx-auto mb-20 sm:mb-30 lg:mb-40"
