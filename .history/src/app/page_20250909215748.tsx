          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className=" group flex gap-4 justify-center">
                <div className="w-10 h-10 bg-[transparent] border-2 border-[#ffcc00] bg-opacity-10 rounded-full flex items-center justify-center transition-colors duration-300 hover:bg-[#ffcc00]">
