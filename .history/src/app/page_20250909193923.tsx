      ...
      <section className="py-40 px-6 bg-[#ffffff]">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center">
            ...
            <div className="">
              <h2 
                className="text-[50px] text-[#ffcc00] text-justify mb-6 leading-tight"
                style={{ fontFamily: "Futura, sans-serif" }}
                >
                  Uma plataforma que
                  <br />
              ...
              <p className="text-[#0C3729] font-dosis font-medium text-[20px] text-justify leading-relaxed max-w-[420px]"
            ...
            <div className="flex justify-center relative">
              ...
              className="w-full max-w-md relative -top-14" 
              />
            </div>
