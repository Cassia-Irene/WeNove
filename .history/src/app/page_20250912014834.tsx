  ...
  return (
    ...
    <div className="min-h-screen relative bg-transparent">
      ...
      <header className="absolute top-0 left-0 w-full h-16 sm:h-20 lg:h-24 z-10 flex items-center justify-between px-4 sm:px-6">
        ...
        <section
          className="relative py-8 sm:py-12 lg:py-16 px-4 sm:px-6 z-20 mt-[-100px] sm:mt-[-120px] lg:mt-[-150px] rounded-[20px] overflow-hidden max-w-[90%] sm:max-w-[70%] lg:max-w-[90%]"
          style={{
