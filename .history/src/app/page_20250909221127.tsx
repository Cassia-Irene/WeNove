      ...
      <footer className="py-12 px-6 bg-[#0c3729]">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              <h4 className="text-[#ffffff] font-dosis text-lg font-bold mb-4 text-center">Navegue</h4>
            ...
            <div>
              <h4 className="text-[#ffffff] font-dosis text font-bold mb-4 text-center">Para você</h4>
              <ul className="space-y-2 text-center">
                <li>
                  <a href="#" className="text-[#ffffff] font-dosis text-m hover:text-[#ffcc00] transition-colors">
