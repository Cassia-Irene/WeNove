        ...
        >
          ...
          <SwiperSlide>
            <div
              className="w-full h-full bg-cover bg-center"
              style={{
                backgroundImage: "url('/jeans-texture-blue.jpg')",
              }}
            ></div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div
              className="w-full h-full bg-cover bg-center"
              style={{
                backgroundImage: "url('/fashion-denim.jpg')",
              }}
            ></div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div
              className="w-full h-full bg-cover bg-center"
              style={{
                backgroundImage: "url('/denim-blue-texture.jpg')",
              }}
            ></div>
          </SwiperSlide>
          ...
          <SwiperSlide>
            <div
              className="w-full h-full bg-cover bg-center"
              style={{
                backgroundImage: "url('/jeans-pattern.jpg')",
              }}
            ></div>
          </SwiperSlide>
        </Swiper>
