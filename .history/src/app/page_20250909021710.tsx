    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-7xl text[80px] text-[#ffffff] mb-6 leading-tight"
          ...
          <p className="text-lg md:text-xl font-dosis text-[30px] text-[#ffffff] mb-8 max-w-2xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
            <Button className="bg-[#8f3332] text-[#ffffff] hover:bg-[#8b3130] px-8 py-3 text-lg font-medium">
              Como Funciona
            </Button>
