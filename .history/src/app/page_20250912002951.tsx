...
export default function WenoveLanding() {
  ...
  return (
    ...
    <div className="min-h-screen relative bg-transparent">
      ...
      <header className="relative top-0 left-0 w-full h-16 sm:h-20 lg:h-24 z-10 flex items-center justify-between px-4 sm:px-6">
        ...
        <img
          ...
          alt="Wenove Logo"
          className="absolute top-4 sm:top-6 lg:top-[30px] left-4 sm:left-6 lg:left-[30px] w-20 sm:w-34 lg:w-auto"
        />
        ...
        <div className="absolute top-4 sm:top-6 lg:top-[30px] left-1/2 -translate-x-1/2 w-[400px] lg:w-[500px] h-[40px] lg:h-[50px] flex items-center justify-center">
