    ...
    <div>
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-7xl text-[#ffffff] font-dosis mb-6 leading-tight"
          ...
          <div className="flex flex-col sm:flex-row gap-10 justify-center mb-12">
            <Button className="bg-[#8f3332] text-[#ffffff] hover:bg-[#8b3130] px-8 py-6 text-lg font-medium">
              Como Funciona
            </Button>
