...
export default function WenoveLanding() {
  ...
  const heroImages = [
    "/denim-jeans-texture-background-dark-blue.jpeg",
    "/sustainable-fashion-background-1.jpg",
    "/textile-recycling-background.jpg",
    "/vintage-clothing-background.jpg",
    "/eco-fashion-workshop-background.jpg",
  ]
