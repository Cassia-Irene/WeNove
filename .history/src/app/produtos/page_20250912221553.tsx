  ...
  return (
    <div className="min-h-screen bg-[#FFF]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {/* Grade de produtos */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:mb-10">
          {products.map((product) => (
            <Card
              key={product.id}
              className="bg-white rounded-lg shadow-md hover:shadow-lg w-full max-w-[220px] sm:max-w-[200px] md:max-w-[220px] lg:max-w-[220px] sm:items-center"
            >
