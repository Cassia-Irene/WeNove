      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="max-w-md mx-auto relative">
            <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-[#5e4f45] h-6 w-6" />
            <input
              type="text"
              placeholder="Busque por peças, marcas ou materiais..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full pl-10 pr-4 py-3 rounded-full bg-[#88a51d] border-2 border-[#88a51d] focus:outline-none focus:border-[#708943] bg-white"
            />
          </div>
        </div>
