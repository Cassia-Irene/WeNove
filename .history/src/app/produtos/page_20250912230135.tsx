      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-8 lg:mb-10 justify-items-center">
          {products.map((product) => (
            ...
            <Card
              key={product.id}
              className="bg-white rounded-lg shadow-md hover:shadow-lg w-full max-w-[220px] sm:max-w-[200px] md:max-w-[220px] lg:max-w-[220px] xl:max-w-[220px]"
            >
              ...
              <CardContent className="p-4">
                <div className="flex items-center justify-between mb-3">
                  ...
                  <span className="flex items-center justify-center w-[60px] h-[25px] rounded-[20px] bg-[#8B3130] text-white text-xs sm:text-sm font-dosis fotn-bold">
                    {product.price}
                  </span>
