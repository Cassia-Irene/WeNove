  ...
  return (
    <div className="min-h-screen bg-[#FFF]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {/* Filtros */}
        <div className="flex flex-wrap justify-center gap-4 mb-10 xl:mb-20">
        ...
        {/* Grade de produtos */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 lg:mb-10 sm:items-center sm:justify-items-center">
