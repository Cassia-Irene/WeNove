      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="max-w-md mx-auto relative">
            <Search className="absolute left-6 top-1/2 transform -translate-y-1/2 text-[#FFF] h-6 w-6" />
            <input
              type="text"
              placeholder="Busque por peças, marcas ou materiais..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full pl-12 pr-4 py-6 rounded-full border-2 border-[#0C3729] bg-[#88a51d] focus:outline-none focus:border-[#0C3729] text-white placeholder-white font-dosis font-medium"
