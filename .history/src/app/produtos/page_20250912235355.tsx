        ...
        >
          ...
          <div className="max-w-xs sm:max-w-md mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-8 sm:pl-12 xl:pl-30 pr-4 py-2 sm:py-3 rounded-[20px] border-2 border-[#0C3729] bg-[#B2CC57] focus:outline-none focus:border-[#0C3729] text-white placeholder-white font-dosis font-medium"
