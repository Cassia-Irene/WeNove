  ...
  return (
    <div className="min-h-screen bg-[#FFF]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Page Header */}
        <div className="w-screen  sm:-mx-6 lg:-mx-89 py-20 text-center mb-8 bg-[#efe8db]"
        style={{boxShadow: '0 -1px 4px 0 rgba(0,0,0,0.25), 0 1px 4px 0 rgba(0,0,0,0.25)'}}
        >

          <h1 className="text-3xl md:text-6xl text-[#88a51d] mb-8"
          style={{ fontFamily: "Futura, sans-serif" }}
          
          >Explore Produtos</h1>
          <p className="text-[#993F3C] text-lg md:text-2xl font-dosis mb-8 leading-relaxed max-w-3xl mx-auto">
