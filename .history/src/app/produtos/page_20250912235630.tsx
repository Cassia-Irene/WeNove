      ...
      {/* Page Header */}
        ...
        >
          ...
          <div className="max-w-xs sm:max-w-md mx-auto relative">
            <Search className="absolute sm:left-4 lg:left-12 xl:left-20 top-1/2 transform -translate-y-1/2 text-[#FFF] h-4 w-4 sm:h-5 sm:w-5 sm:h-6 sm:w-6 " />
            ...
            <input
              ...
              className="w-full pl-8 sm:pl-10 lg:pl-24 xl:pl-30 pr-4 py-2 sm:py-3 rounded-[20px] border-2 border-[#0C3729] bg-[#B2CC57] focus:outline-none focus:border-[#0C3729] text-white placeholder-white font-dosis font-medium"
