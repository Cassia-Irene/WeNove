        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-4 gap-8 lg:mb-10 justify-items-center">
          {products.map((product) => (
            <Link
              ...
              className="w-full"
            >
              <Card className="justifyi-center rounded-lg border-none hover:shadow-lg w-full max-w-[280px] sm:max-w-[200px] md:max-w-[220px] lg:max-w-[220px] xl:max-w-[300px] py-0 cursor-pointer">
