...
const productData = {
  1: {
    ...
    images: [
      "/denim-bag-sustainable-fashion.jpg",
      "/denim-bag-sustainable-fashion.jpg",
      "/denim-bag-sustainable-fashion.jpg",
      "/denim-bag-sustainable-fashion.jpg",
    ],
    description:
      "Bolsa Eco Jeans — sustentável e exclusiva, feita com retalhos reaproveitados, unindo design moderno e consumo consciente.",
    seller: {
      name: "Ana Luiza",
      role: "Moda Upcycle",
      avatar: "/woman-profile.png",
      description:
        "Transformo retalhos de jeans esquecidos em peças exclusivas, unindo criatividade, moda e sustentabilidade.",
    },
    details: {
    ...
    relatedProducts: [
      { id: 2, name: "Bucket Eco Jeans", price: 35.0, image: "/denim-bag-sustainable-fashion.jpg" },
      { id: 3, name: "Calça Eco Jeans", price: 65.0, image: "/green-wide-leg-pants-sustainable.jpg" },
      { id: 4, name: "Jaqueta Eco Jeans", price: 85.0, image: "/denim-jacket-upcycled.jpg" },
    ],
    productReviews: [
      {
        id: 1,
        rating: 5,
        date: "20 mar 2025",
        comment: "A bolsa é linda, resistente e combina com tudo! Adorei saber que é sustentável!",
        images: ["/denim-bag-sustainable-fashion.jpg", "/denim-bag-sustainable-fashion.jpg"],
      },
      {
        id: 2,
        rating: 5,
...
export default function ProductPage({ params }: { params: { id: string } }) {
  ...
  return (
    <div className="min-h-screen bg-[#efe8db]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16 sm:h-20">
            ...
            <Link href="/" className="flex items-center">
              <Image
                src="/placeholder.svg?height=40&width=120&text=WeNove"
                alt="WeNove"
                width={120}
                height={40}
            ...
            <nav className="hidden md:flex space-x-8">
              <Link href="/" className="bg-[#88a51d] text-white px-4 py-2 rounded-full text-sm font-medium">
                Início
              </Link>
              <Link href="#" className="bg-[#88a51d] text-white px-4 py-2 rounded-full text-sm font-medium">
                Sobre nós
              </Link>
              <Link href="/produtos" className="bg-[#88a51d] text-white px-4 py-2 rounded-full text-sm font-medium">
                Produtos
              </Link>
              <Link href="#" className="bg-[#88a51d] text-white px-4 py-2 rounded-full text-sm font-medium">
                Contato
            ...
            <div className="flex items-center space-x-2 sm:space-x-4">
              <div className="relative">
                ...
                <span className="absolute -top-1 -right-1 bg-[#8f3332] text-white text-xs rounded-full w-4 h-4 sm:w-5 sm:h-5 flex items-center justify-center">
                  0
                </span>
              </div>
            ...
            <Card className="bg-[#e5dc3c] bg-opacity-20 border-none">
              <CardContent className="p-4 sm:p-6">
                ...
                <div className="flex items-center mb-4">
                  ...
                  <span className="ml-2 text-sm text-gray-600">({product.productReviews.length})</span>
                </div>

                {/* Price */}
                <div className="text-2xl sm:text-3xl font-bold text-[#0c3729] mb-4">R$ {product.price.toFixed(2)}</div>
      ...
      {/* Footer */}
      <footer className="bg-[#0c3729] text-white mt-12 sm:mt-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              />
              <p className="text-sm text-gray-300 mb-4">© 2025 WeNove. Todos direitos reservados</p>
              <div className="flex space-x-4">
                <div className="w-8 h-8 bg-white bg-opacity-40 rounded-full flex items-center justify-center">
                  <span className="text-[#0c3729] text-sm font-bold">W</span>
                </div>
                <div className="w-8 h-8 bg-white bg-opacity-40 rounded-full flex items-center justify-center">
                  <span className="text-[#0c3729] text-sm font-bold">@</span>
                </div>
                <div className="w-8 h-8 bg-white bg-opacity-40 rounded-full flex items-center justify-center">
                  <span className="text-[#0c3729] text-sm font-bold">in</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="/" className="hover:text-[#88a51d]">
                    Início
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/produtos" className="hover:text-[#88a51d]">
                    Produtos
                  </Link>
                </li>
                <li>
            ...
            {/* User Actions */}
            <div>
              <h3 className="text-lg font-bold mb-4">Para você</h3>
              <ul className="space-y-2 text-sm">
                <li>
                  <Link href="#" className="hover:text-[#88a51d]">
