        ...
        >
          ...
          <div className="max-w-xs sm:max-w-md mx-auto relative">
            ...
            <input
              ...
              className="w-full pl-8 sm:pl-10 xl:pl-30 pr-4 py-2 sm:py-3 rounded-20 border-2 border-[#0C3729] bg-[#88a51d] focus:outline-none focus:border-[#0C3729] text-white placeholder-white font-dosis font-medium"
