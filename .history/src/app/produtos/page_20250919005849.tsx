...
export default function ProdutosPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF]">
        ...
        <div className="fixed inset-0 z-50 sm:hidden">
          ...
          <div className="absolute left-0 top-0 h-full w-80 bg-[#0C3729] shadow-xl">
            ...
            <nav className="flex flex-col p-6 space-y-6">
              <Link
                href="/"
                className="text-white text-lg font-dosis hover:text-[#FFCC00]"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Início
              </Link>
      ...
      >
        <h1
          className="text-3xl sm:text-3xl lg:text-4xl xl:text-5xl text-[#88a51d] mb-4 xl:mb-8"
          style={{ fontFamily: "Futura, sans-serif" }}
        >
          Explore Produtos
        </h1>

        <p className="text-[#993F3C] text-lg md:text-2xl font-dosis font-medium mb-4 max-w-3xl mx-auto">
        ...
        <div className="max-w-xs sm:max-w-md mx-auto relative">
          ...
          <input
            ...
            className="w-full pl-10 lg:pl-28 pr-4 py-2 sm:py-3 rounded-[20px] border-2 border-[#0C3729] bg-[#B2CC57] text-white placeholder-white font-dosis font-medium focus:outline-none focus:border-[#0C3729]"
            style={{
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        {/* Botão centralizado só entre 1024px e 1279px */}
        <div className="hidden lg:flex xl:hidden justify-center mb-6">
          <Filtros />
        </div>

        <div className="grid grid-cols-1 xl:grid-cols-4 gap-8">
          {/* Sidebar fixa só no desktop xl+ */}
          ...
          <div className="col-span-1 xl:col-span-3">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-8 lg:mb-10 justify-items-center">
                  ...
                  <Card className="rounded-lg border-none hover:shadow-lg w-full max-w-[280px] sm:max-w-[200px] md:max-w-[220px] lg:max-w-[220px] xl:max-w-[300px] py-0 cursor-pointer">
                    ...
                    <CardContent className="p-2">
                      <div className="flex items-center justify-between mb-3">
                        <h3 className="font-dosis font-semibold text-[#0C3729] text-sm sm:text-base">
                          {product.name}
                        </h3>
