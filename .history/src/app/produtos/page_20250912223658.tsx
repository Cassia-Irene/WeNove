...
export default function ProdutosPage() {
  ...
  return (
    <div className="min-h-screen bg-[#FFF]">
      ...
      {/* Page Header */}
        <div className="py-10 xl:py-15 text-center mb-8 xl:mt-10 xl:mb-20 bg-[#efe8db]"
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-5 gap-8 lg:mb-10 justify-items-center">
          {products.map((product) => (
            
            <Card
              key={product.id}
              className="bg-white rounded-lg shadow-md hover:shadow-lg w-full max-w-[220px] sm:max-w-[200px] md:max-w-[220px] lg:max-w-[220px]"
            >
              <div className="w-full h-[240px] rounded-t-lg overflow-hidden">
                <img
              ...
              <CardContent className="p-4">
                <h3 className="font-dosis font-semibold text-[#0C3729] mb-2 text-sm sm:text-base md:text-base lg:text-base">{product.name}</h3>
                
                <div className="flex items-center justify-between mb-3">
                  <span className="text-sm sm:text-base md:text-base lg:text-base font-dosis font-bold text-[#8f3332]">{product.price}</span>
                </div>
                ...
                <div className="flex items-center space-x-2">
                  ...
                  />
                  <span className="font-dosis font-bo text-sm text-[#88A51D]">{product.seller}</span>
                </div>
              </CardContent>
            </Card>
          ))}
