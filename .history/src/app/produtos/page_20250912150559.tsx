    ...
    <div className="min-h-screen bg-[#FFF]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-8">
        ...
        >
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl text-[#88a51d] mb-2 sm:mb-4 xl:mb-8"
          ...
          <div className="max-w-xs sm:max-w-md mx-auto relative">
            <Search className="absolute left-20 top-1/2 transform -translate-y-1/2 text-[#FFF] h-4 w-4 sm:h-5 sm:w-5 sm:h-6 sm:w-6 " />
            ...
            <input
              ...
              className="w-full pl-30 sm:pl-10 pr-4 py-2 sm:py-3 rounded-full border-2 border-[#0C3729] bg-[#88a51d] focus:outline-none focus:border-[#0C3729] text-white placeholder-white font-dosis font-medium"
