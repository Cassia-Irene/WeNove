  ...
  return (
    <div className="min-h-screen bg-[#FFF]">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        {/* Page Header */}
        <div className="w-screen  sm:-mx-6 lg:-mx-89 py-15 text-center mb-8 bg-[#efe8db]"
        ...
        >
          ...
          <div className="max-w-md mx-auto">
            <div
                className="flex items-center w-full rounded-full border-2 border-[#0C3729] bg-[#88a51d] px-4 py-3 shadow-md focus-within:border-[#0C3729]"
                style={{ boxShadow: '0 4px 4px 0 rgba(0, 0, 0, 0.25)' }}
            ></div>
            <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 text-[#FFF] h-6 w-6" />
            <input
              type="text"
              placeholder="Busque por peças, marcas ou materiais..."
              value={searchQuery}
              onChange={(e) => setSearchQuery(e.target.value)}
              className="w-full pl-12 pr-4 py-3 rounded-full border-2 border-[#0C3729] bg-[#88a51d] focus:outline-none focus:border-[#0C3729] text-white placeholder-white font-dosis font-medium"
              style={{ boxShadow: '0 4px 4px 0 rgba(0, 0, 0, 0.25)' }}
            />
          </div>
        </div>
