        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-[#88A51D] font-dosis font-semibold text-m leading-relaxed">Moda que faz sentido para você e para o planeta.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-[#88a51d] mb-3">Sustentabilidade real</h3>
              
              <p className="text-[#88A51D] text-sm leading-relaxed">Menos descarte, mais responsabilidade.</p>
            </div>
