    ...
    <div className="min-h-screen relative bg-transparent">
      ...
      <header className="absolute top-0 left-0 w-full h-16 sm:h-20 lg:h-24 z-10 flex items-center justify-between px-4 sm:px-6">
        ...
        <img
          ...
          alt="Wenove Logo"
          className="absolute top-4 sm:top-8 lg:top-[30px] left-4 sm:left-6 lg:left-[30px] w-34 sm:w-34 lg:w-auto"
        />

        <button
          onClick={() => setIsMobileMenuOpen(true)}
          className="sm:hidden absolute top-4 right-4 w-10 h-10 bg-[#CDBBA7]/40 rounded-full flex items-center justify-center shadow-[0_4px_4px_rgba(0,0,0,0.45)]"
        >
