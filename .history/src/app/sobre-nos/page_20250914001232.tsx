  ...
  return (
    <div>
        ...
        <section className="relative w-full h-screen overflow-hidden flex items-center justify-center">
          ...
          <div
            className="absolute inset-0 w-full h-[807px] bg-cover bg-center"
            style={{ backgroundImage: "url('/img-sobre-nos.png')" }}
          />
        
        {/* Overlay escuro */}
          <div className="absolute h-[807] inset-0 bg-black/60" />

        {/* Conteúdo central opcional */}
          <div className="relative z-10 text-white text-center">
            <h1 className="top-[20%text-3xl md:text-5xl font-bold">Sobre Nós</h1>
          </div>
