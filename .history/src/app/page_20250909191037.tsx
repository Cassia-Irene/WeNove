        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="max-w-[550px]">
              <h2 
                className="text-5xl text-[#ffcc00] text-justify mb-6 leading-tight"
                style={{ fontFamily: "Futura, sans-serif" }}
                >
                  Uma plataforma que
                  <br />
              ...
              <p className="text-[#0C3729] font-dosis font-medium text-lg text-justify leading-relaxed">
            ...
            <div className="flex justify-center relativw">
