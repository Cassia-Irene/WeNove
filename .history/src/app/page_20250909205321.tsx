...
export default function WenoveLanding() {
  ...
  <header className="absolute top-0 left-0 w-full h-24 z-10 flex items-center justify-between px-6">
    ...
    <div>
      ...
      <section className="relative py-16 px-6 h-[500px] max-w-[1300px] bg-[#0c3729] rounded-[20px] overflow-hidden mx-auto mb-40 boxShadow: -4px -4px 4px 0 rgba(0, 0, 0, 0.25), 4px 4px 4px 0 rgba(0, 0, 0, 0.25)Z">
