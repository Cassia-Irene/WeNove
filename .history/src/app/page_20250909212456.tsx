        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <p className="text-[#88A51D] font-dosis font-semibold text-m leading-relaxed text-center mx-auto max-w-[240px]">Moda que faz sentido para você e para o planeta.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#88A51D] text-center font-dosis font-semibold text-m leading-relaxed text-center mx-auto max-w-[240px]">Menos descarte, mais responsabilidade.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#88A51D] font-dosis font-semibold text-m leading-relaxed text-center mx-auto max-w-[240px]">Pessoas, marcas e empreendedores juntos.</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[#88a51d] font-dosis font-semibold text-m leading-relaxed text-center mx-auto max-w-[240px]">
                Cada peça tem um novo propósito e reduz o lixo t.
              </p>
            </div>
          </div>
        </div>
